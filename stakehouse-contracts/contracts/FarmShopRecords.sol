...
/**
  @title A basic smart contract for tracking the ownership of Stakehouse Shops.
  @author Tim Clancy

  This is the governing registry of all Stakehouse Shop assets.
*/
contract FarmShopRecords is Ownable {
  ...
  /**
    Construct a new registry of Stakehouse records with a specified platform fee owner.
  ...
  */
  function createShop(string calldata _name, Staker[] calldata _stakers) external returns (Shop1155) {
