...
/**
  @title A basic smart contract for tracking the ownership of Stakehouse Tokens.
  @author Tim Clancy

  This is the governing registry of all Stakehouse Token assets.
*/
contract FarmTokenRecords is Ownable {
  ...
  */
  function createToken(string calldata _name, string calldata _ticker, uint256 _cap, address[] calldata _directMintAddresses, uint256[] calldata _directMintAmounts) external returns (Token) {
